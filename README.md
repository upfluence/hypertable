...
- `replayOn` (string[]): List of handler event names that trigger the animation again after the initial play. Default: `[]`. See [Events](#events) for available event names.
